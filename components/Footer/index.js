      ...
      <div className="mt-5 laptop:mt-40 p-2 laptop:p-0 text-center">
        <div>
          ...
          <div className="mt-6">
            ...
            <div className="inline-block w-max text-white transition-all duration-300 ease-out hover:scale-105 bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2 mt-8">
